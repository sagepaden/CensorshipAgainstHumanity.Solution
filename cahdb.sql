...
CREATE TABLE `blackcards` (
  `BlackCardsId` int NOT NULL AUTO_INCREMENT,
  `Text` text,
  PRIMARY KEY (`BlackCardsId`),
  UNIQUE KEY `BlackCardsId_UNIQUE` (`BlackCardsId`)
...
CREATE TABLE `whitecards` (
  `Text` text,
  `WhiteCardsId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`WhiteCardsId`),
  UNIQUE KEY `WhiteCardsId_UNIQUE` (`WhiteCardsId`)
